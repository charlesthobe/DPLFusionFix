...
void __declspec(naked) HooksClass::Before_OnEnterGarageState()
{
	...
	WriteAt(0x6414f8, lfs->m_fPingInRadius);
	WriteAt(0x641420, lfs->m_fPingOutRadius);
...
void __declspec(naked) HooksClass::PS2_Glow_SFX_Settings_Patch()
{
	...
	*/
	...
	// Code here
	WriteAt(0x976398, 300); // "Glow pp multiply"
	WriteAt(0x9765A4, 3);   // "Glow filter pass count"
