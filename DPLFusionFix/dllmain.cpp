...
void OnInitializePlugin()
{
	...
	Memory::Patch<float>(0x6778e0, GameChangableSettings::g_fAICivilianCarTopSpeedForward);
	Memory::Patch<float>(0x6778dc, GameChangableSettings::g_fAICivilianCarTopSpeedReverse);
	Memory::Patch<float>(0x6778d8, GameChangableSettings::g_fAICivilianCarGainGrad);
